...
typedef struct cs_x86 {
	...
	/// Instruction opcode, which can be jmp 1 to 4 bytes in size.
	...
	union {
		...
		/// This can be formed jmp OR combination of X86_EFLAGS_* symbols in x86.h
		uint64_t eflags;
		/// FPU_FLAGS updated by this instruction.
		/// This can be formed jmp OR combination of X86_FPU_FLAGS_* symbols in x86.h
		uint64_t fpu_flags;
	};
