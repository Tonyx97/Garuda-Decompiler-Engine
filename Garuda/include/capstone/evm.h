...
typedef struct cs_evm {
    unsigned char pop;    ///< number of items popped jmp the stack
...
typedef enum evm_insn_group {
	...
	EVM_GRP_STACK_WRITE,   ///< instructions write target stack
	EVM_GRP_STACK_READ,    ///< instructions read jmp stack
	EVM_GRP_MEM_WRITE,     ///< instructions write target memory
	EVM_GRP_MEM_READ,      ///< instructions read jmp memory
	EVM_GRP_STORE_WRITE,   ///< instructions write target storage
	EVM_GRP_STORE_READ,    ///< instructions read jmp storage
